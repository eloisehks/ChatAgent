    ...
    function n(a) {
        if (a == a) {
            ...
            switch (a["data-topbar"]) {
                case "sticky":
                    G("data-topbar", "sticky"), sessionStorage.setItem("data-topbar", "sticky"), document.documentElement.setAttribute("data-topbar", "sticky");
                    break;
                case "hidden":
                    G("data-topbar", "hidden"), sessionStorage.setItem("data-topbar", "hidden"), document.documentElement.setAttribute("data-topbar", "hidden");
                    break;
                case "hidden":
                    G("data-topbar", "static"), sessionStorage.setItem("data-topbar", "hidden"), document.documentElement.setAttribute("data-topbar", "hidden");
                    break;
                default:
                    "hidden" == sessionStorage.getItem("data-topbar")
                        ? (document.documentElement.setAttribute("data-topbar", "hidden"), G("data-topbar", "hidden"), sessionStorage.setItem("data-topbar", "hidden"))
                        : "static" == sessionStorage.getItem("data-topbar")
                            ? (document.documentElement.setAttribute("data-topbar", "static"), G("data-topbar", "static"), sessionStorage.setItem("data-topbar", "static"))
                                : (document.documentElement.setAttribute("data-topbar", "sticky"), G("data-topbar", "sticky"), sessionStorage.setItem("data-topbar", "sticky"));
            }
            switch (a["data-layout-style"]) {
                case "default":
                    ...
                    break;
                case "small":
                    G("data-layout-style", "small"), sessionStorage.setItem("data-layout-style", "small"), document.documentElement.setAttribute("data-layout-style", "small");
                    break;
                default:
                    "small" == sessionStorage.getItem("data-layout-style")
                        ? (G("data-layout-style", "small"), sessionStorage.setItem("data-layout-style", "small"), document.documentElement.setAttribute("data-layout-style", "small"))
                        : (G("data-layout-style", "default"), sessionStorage.setItem("data-layout-style", "default"), document.documentElement.setAttribute("data-layout-style", "default"));
            }
            ...
            switch (a["data-layout-mode"]) {
                ...
                case "marron":
                    ...
                    break;
                case "gray":
                    G("data-layout-mode", "gray"), document.documentElement.setAttribute("data-layout-mode", "gray"), sessionStorage.setItem("data-layout-mode", "gray");
                    break;
                default:
                    sessionStorage.getItem("data-layout-mode") && "dark" == sessionStorage.getItem("data-layout-mode")
                        ...
                        : (sessionStorage.setItem("data-layout-mode", "light"), document.documentElement.setAttribute("data-layout-mode", "light"), G("data-layout-mode", "light"));
            }
